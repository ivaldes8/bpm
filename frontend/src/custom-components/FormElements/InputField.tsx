...
import { FormInput, FormCheck, FormLabel, InputGroup } from "@/components/Base/Form";
...
const InputField = ({ control, name, type = "text", labelEnabled = true, info, label, placeholder, disabled = false, showIcon = false, icoName = "Bone", animationDirection = "intro-x", disableM = false, petName = false }: Props) => {
